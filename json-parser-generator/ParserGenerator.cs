...
namespace json_parser_generator
{
    ...
    public class ParserGenerator
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ShiftReduceParser CreateExtendedShiftReduceParserInstance()
        {
            ...
            return new ShiftReduceParser(symbol_table, acc_max + 1, table, grammar_group.ToArray(), grammar.Select(x => x.Count).ToArray(), semantic_rules);
        }
    ...
    public class ShiftReduceParser
    {
        ...
        public ShiftReduceParser(Dictionary<string, int> symbol_table, int accept_code, int[][] table, int[] group_table, int[] production, List<ParserAction> actions)
        {
